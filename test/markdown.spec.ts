...
import { fixMarkdownFormatting, chunkForDiscord } from '../src/index';
...
describe('markdown/url fixes', () => {
	...
	it('removes \"! \" residue before URLs', () => {
		const fixed = fixMarkdownFormatting('ok!\n! https://example.com/a\nwow! https://example.com/b');
	...
	it('does not split a URL across discord chunks', () => {
		const url = 'https://example.com/this/is/a/very/long/path?with=query&and=more';
